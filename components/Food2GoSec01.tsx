            ...
            <div className="w-full min-h-[100vh] flex flex-col gap-12 md:gap-24 lg:gap-36 px-10 lg:px-32 py-16">
                ...
                <div className="flex flex-col items-center gap-16">
                    ...
                    >
                        ...
                        {/* Animate the img coming from the right */}
                        <motion.span
                            initial={{ x: '100vw' }}
                            animate={{ x: 0 }}
                        ...
                        accessible with ease and speed. Order what makes you happy with just a 
                        
                        <span
                           className="italic border border-white rounded-full  ml-4 px-5 lg:pl-7 lg:pr-9 pb-1"
                        >
                            tap!
                        </span>
                    </motion.h1>

                    {/* Animate the bottom image */}
                    <motion.div
                        initial={{ scale: 0, y: '100vh' }}
                        animate={{ scale: 1, y:0 }}
                        transition={{ type: 'spring', stiffness: 20, delay: 0.9, damping: 6 }}
                        className="w-24 lg:w-32"
                    >
                        <img src="/Group 48095639.png" />
                    </motion.div>
                </div>
            </div>
                ...
                <div className="max-w-[600px] space-y-6 md:p-4">
                    ...
                    <ul className="space-y-4 px-8">
                        {Food2GoProblems.map((item, index) => (
                            <li key={index} className="text-lg lg:text-xl px-4 list-disc leading-relaxed">
                                {item}
                            </li>
                        ))}
                    </ul>
